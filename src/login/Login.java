...
public class Login {
 ...
 private static String NAME_EXSIST = "THIS NAME OR PASS IS INVALID. PLEASE TRY AGAIN";
...
public void actionPerformed(ActionEvent arg0) {
  ...
  frameLoginForm.getContentPane().add(passwordField);
  
  JLabel lblNewLabel = new JLabel("Password");
  lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 13));
  lblNewLabel.setBounds(46, 175, 70, 22);
  ...
  btnNewButton.setBounds(44, 217, 157, 59);
  frameLoginForm.getContentPane().add(btnNewButton);
  lblError.setVisible(false);
